...
<html>
  ...
  <body>
    ...
    <ul class="gnb-list">
            ...
            <ul class="dropdown-menu">
              <c:forEach items="${categoryList}" var="CategoryVO">
                <li>
                  <a
                    class="dropdown-item"
                    href="tohomeServlet?command=product_by_category&categoryId=${CategoryVO.categoryId}"
                    >${CategoryVO.categoryType}</a
                  >
                </li>
              </c:forEach>
            </ul>
      ...
      <li>
        <a href="tohomeServlet?command=product_All" style="color: #41464b"
          >전체상품</a
        >
      </li>
      <li>
        <a href="tohomeServlet?command=product_sale" style="color: #41464b"
          >세일</a
        >
      </li>
      <li>
        <a href="tohomeServlet?command=prouduct_new" style="color: #41464b"
          >신상품</a
        >
      </li>
